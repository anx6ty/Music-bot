...
async def resolve_query_items(
    ...
    # Playlists use the flat extractor (fast, lightweight).
    # Everything else uses the full extractor as before.
    extractor = (
        ytdl_flat
...
# ============================================================
# NOTE: /servers, /geninvite, and /resetpfpall used to live
# here as bot-owner-only slash commands. They've been moved
# to mention/prefix text commands (see the on_message handler
# above) so they no longer show up in Discord's "/" menu.
# ============================================================
